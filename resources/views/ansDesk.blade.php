...
<style>
    ...
    <div class="container" id="question_bg"> 
        
        
        
        <form method="post" action="{{route('submitans')}}" id="quizForm">
            @csrf
        <div class="row" >
            
            <div class="col-md-3"></div>
            <div class="col-md-6 text-white ">
                <div class="time_count mb-3" id="time_count" >
                    Time Left : <span class="text-primary" id="timer"></span>
                </div>
